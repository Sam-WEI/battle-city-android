...
data class Tank(
    ...
    val x: MapPixel = 0f,
    val y: MapPixel = 0f,
    val movingDirection: Direction = Direction.Down,
...
private val BotLevel4Specs = TankSpecs(maxHp = 4, movingSpeed = 0.03f, bulletSpeed = 0.18f, bulletPower = 1, fireCooldown = 200, maxBulletCount = 1)
